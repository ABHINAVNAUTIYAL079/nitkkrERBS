...
const teamMembers = [
    {
        ...
        github: "https://github.com/ashishkumarpandey9882",
        linkedin: "https://www.linkedin.com/in/ashish-pandey-228532304/",
        bio: "Developed the main user interface including the booking form, ride tracking pages, and responsive layouts using Next.js and Tailwind CSS.",
        avatar: null,
        initials: "AKP",
    },
    {
        name: "Abhinav Nautiyal",
        role: "Maps & Location System",
        rollNo: "124102002",
        branch: "Computer Science & Engineering",
        year: "2nd Year",
        email: "124102002@nitkkr.ac.in",
        github: "https://github.com/ABHINAVNAUTIYAL079/nitkkrERBS",
        linkedin: "https://www.linkedin.com/in/abhinav-nautiyal-89bb92328/",
        bio: "Implemented the campus map using Leaflet, added predefined NIT Kurukshetra pickup/drop locations, and integrated route visualization for ride selection.",
        avatar: null,
        initials: "AN",
    },
    {
        ...
        bio: "Designed MongoDB database schemas and developed backend APIs for booking management, authentication, and driver operations.",
        avatar: null,
        initials: "SS",
    },
    {
        ...
        github: "#",
        linkedin: "https://www.linkedin.com/in/allaka-mahesh-95bba3378?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
        bio: "Performed system testing, validated booking workflows, and helped integrate frontend, backend, and map modules to ensure smooth operation.",
        avatar: null,
        initials: "M",
    },
    {
        ...
        bio: "Designed the visual layout, color scheme, and user experience for the platform, ensuring an intuitive and user-friendly interface.",
        avatar: null,
        initials: "SY",
    },
];
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <section className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="flex flex-wrap justify-center gap-3">
                    {["React (Vite)", "Express.js", "MongoDB", "Tailwind CSS", "Leaflet Maps", "OSRM Routing", "JWT Auth", "REST APIs"].map((tech) => (
                        <span
                            key={tech}
