...
import {
    ...
    ShieldCheck, Truck, UserCircle
} from "lucide-react";
import { Spinner } from "@/components/ui";

const ROLES = [
    { id: "user", label: "User", icon: UserCircle, color: "from-green-500 to-emerald-600", accent: "green" },
    { id: "driver", label: "Driver", icon: Truck, color: "from-blue-500 to-indigo-600", accent: "blue" },
    { id: "admin", label: "Admin", icon: ShieldCheck, color: "from-orange-500 to-red-600", accent: "orange" },
];
                        ...
                        <>
                            ...
                            <form onSubmit={handleDriverLogin} className="space-y-4">
                                ...
                                <div>
                                    <div className="flex items-center justify-between mb-1.5">
                                        <label className="block text-xs font-medium text-slate-600 dark:text-slate-300">Password</label>
                                        <Link to="/forgot-password?type=driver" className="text-xs text-blue-500 hover:text-blue-400">
                                            Forgot Password?
                                        </Link>
                                    </div>
                                    <div className="relative">
                                ...
                                <p className="text-center text-xs text-slate-500 dark:text-slate-400">
                                    New driver?{" "}
                                    <Link to="/driver/register" className="text-blue-500 hover:underline font-medium">
                                        Register here
                                    </Link>
                                </p>
                            </form>
