...
export default function Navbar() {
    ...
    return (
        <nav className="bg-slate-900/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-slate-700/50 sticky top-0 z-[1001] transition-colors">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex items-center gap-1">
                        <Link
                            href="/about"
                            className="px-4 py-2 text-base font-medium text-slate-300 hover:text-amber-400 hover:bg-amber-900/20 rounded-lg transition-colors"
                        >
                            About Us
                        </Link>
                ...
                {isOpen && (
                    <div className="md:hidden pb-4 space-y-1">
                        <Link
                            href="/about"
                            className="block px-4 py-2 text-base font-medium text-slate-300 hover:bg-slate-800 rounded-lg"
