                ...
                <div className="w-full max-w-md text-center">
                    <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-10 shadow-2xl">
                        ...
                        <p className="text-slate-400 text-sm leading-relaxed mb-8">
                            ...
                            . You will be able to login once an admin approves
                            your account.
                        </p>
                        <Link
                            href="/login"
                            className="inline-block w-full py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold rounded-xl transition-all shadow-lg hover:shadow-blue-500/30 text-sm"
                        >
                            Go to Driver Login
                        </Link>
                    </div>
                ...
                <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-8 shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2.5 bg-white/10 border border-white/20 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm uppercase"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-10 py-2.5 bg-white/10 border border-white/20 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm"
                                />
                                <button
                                    type="button"
                                    onClick={() =>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-10 pr-10 py-2.5 bg-white/10 border rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 text-sm transition-colors ${form.confirmPassword &&
                        ...
                        <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl px-4 py-3 text-xs text-yellow-300">
                            ⚠️ Your account will require{" "}
                            <span className="font-semibold">admin approval</span>{" "}
                            before you can login and accept rides.
                        </div>

                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold rounded-xl transition-all shadow-lg hover:shadow-blue-500/30 disabled:opacity-60 text-sm mt-2"
                        >
                            {loading ? (
                                <Spinner size="sm" />
                            ) : (
